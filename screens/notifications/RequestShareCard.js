...
export default RequestShareCard = (props) => {
    return (
        <TouchableOpacity style={styles.container} onPress={() => props.navigation.navigate('CommunityRequests') }>
            <Image source={{uri: props.book.image}} style={styles.profileImage}/>
            <View style={{flex: 1}}>
                <Text>A user requested your book: 
